...
public class RegistroCriadorService {
    ...
    // Passo 1: UsuÃ¡rio envia os documentos e informaÃ§Ãµes
    public void enviarDocumentos(@NonNull Integer userId, String lattes,
        ...
        Usuario user = userRepo.findById(userId).orElseThrow(() -> new RuntimeException("UsuÃ¡rio nÃ£o encontrado"));
